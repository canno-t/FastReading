        ...
        <div class="d-flex flex-column" style="width: 66%">
            <div class="mb-5 first-stage">
                ...
                <div class="justify-content-between align-items-center px-5 py-2" style="text-align: center;display: flex;border: solid 2px #d6d6d6;border-radius: 25px" id="article">
                    <span class="d-flex"><span class="material-symbols-outlined align-self-center mr-1" style="margin-right: 0.25rem">timer</span><span id="timer" style="font-size: 30px;margin-left: 0.25rem">{{round($time/60)}}:{{$time-(round($time/60)*60)}}</span></span>
                    <span style="font-size: 30px">{{$words}} słów</span>
